	...
	return (
		<Section id="contact" className="h-screen flex justify-center">
			<div className="self-center text-center">
				...
				<a data-mdb-ripple="true" data-mdb-ripple-color="primary" href="mailto:balico.danielshan@gmail.com" className="border border-primary px-6 py-3 rounded text-primary hover:bg-primary-light dark:hover:bg-primary-dark transition-all duration-300">
					Say Hello
				</a>	
			</div>
		</Section>
